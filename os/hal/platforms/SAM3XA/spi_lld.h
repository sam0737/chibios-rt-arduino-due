...
/**
 * @file    SAM3XA/spi_lld.h
 * @brief   SPI Driver subsystem low level driver header.
 *
 * @addtogroup SPI
 * @{
 */
 ...
 */
#if !defined(SAM3XA_SPI_USE_SPI1) || defined(__DOXYGEN__)
#define SAM3XA_SPI_USE_SPI1               FALSE
#endif
 ...
 */
#define SAM3XA_SPI_DEFAULT_IRQ_PRIORITY             12
...
typedef struct {
  ...
  uint32_t                  speed;
  PeripheralPinConfig       spck_pin;
  PeripheralPinConfig       miso_pin;
...
struct SPIDriver {
  ...
  /* End of the mandatory fields.*/
  /**
   * @brief The peripheral id of the SPI device
   */
